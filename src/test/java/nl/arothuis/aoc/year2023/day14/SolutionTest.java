...
public class SolutionTest {
    private final String EXAMPLE_INPUT = PuzzleInput.getFromFile("2023", "14-example");
    private final String PUZZLE_INPUT = PuzzleInput.getFromFile("2023", "14");
